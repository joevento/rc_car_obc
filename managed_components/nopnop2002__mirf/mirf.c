...
void spi_csnHi(NRF24_t * dev) {
    ...
    esp_rom_delay_us(10); // Small delay after CSN high
}

void spi_csnLow(NRF24_t * dev) {
	gpio_set_level( dev->csnPin, 0 );
    esp_rom_delay_us(10); // Small delay after CSN low
}
...
void Nrf24_ceHi(NRF24_t * dev) {
    ...
    esp_rom_delay_us(10); // Small delay after CE high
}

void Nrf24_ceLow(NRF24_t * dev) {
	gpio_set_level( dev->cePin, 0 );
    esp_rom_delay_us(10); // Small delay after CE low
}
